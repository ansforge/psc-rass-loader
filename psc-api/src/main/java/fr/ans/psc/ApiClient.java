...
import fr.ans.psc.auth.Authentication;
import fr.ans.psc.auth.HttpBasicAuth;
import fr.ans.psc.auth.ApiKeyAuth;
import fr.ans.psc.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-12-30T08:44:48.497Z[GMT]")@Component("fr.ans.psc.ApiClient")
