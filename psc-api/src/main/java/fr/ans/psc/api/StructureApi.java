...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-12-30T08:44:48.497Z[GMT]")@Component("fr.ans.psc.api.StructureApi")
public class StructureApi {
    ...
    public void createNewStructure(Structure body) throws RestClientException {
        createNewStructureWithHttpInfo(body);
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> createNewStructureWithHttpInfo(Structure body) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/v2/structure").build().toUriString();
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> deleteStructureByStructureIdWithHttpInfo(String structureId) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/v2/structure/{structureId}").buildAndExpand(uriVariables).toUriString();
    ...
    public Structure getStructureById(String structureId) throws RestClientException {
        return getStructureByIdWithHttpInfo(structureId).getBody();
    }
     ...
     * <p><b>404</b> - Not Found
     * @param structureId  (required)
     * @return ResponseEntity&lt;Structure&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Structure> getStructureByIdWithHttpInfo(String structureId) throws RestClientException {
        Object postBody = null;
        // verify the required parameter 'structureId' is set
        if (structureId == null) {
    ...
    public void updateStructure(Structure body) throws RestClientException {
        updateStructureWithHttpInfo(body);
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> updateStructureWithHttpInfo(Structure body) throws RestClientException {
        Object postBody = body;
        // verify the required parameter 'body' is set
        if (body == null) {
