...
public enum EmailNature {
    ...
    PROCESS_FINISHED( "PSCLOAD - Fin de process", "Le process spcload s'est terminé correctement."),
    ...
    UPLOAD_INCOMPLETE("PSCLOAD - Chargement incomplet des modifications", "Les modifications du RASS ont été partiellement traitées."),

    /** The process has been interrupted */
	TRIGGER_EXTRACT_FAILED("PSCLOAD - échec de la génération de l'extract",
            "Le chargement des modifications de pscload a bien eu lieu mais la génération de l'extract sécurisé n'a pas été déclenchée.\n" +
     ...
     */
    EmailNature(String subject, String message) {this.subject = subject; this.message = message;}
}
